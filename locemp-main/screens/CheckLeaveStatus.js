...
//       try {
//         const q = query(collection(db, 'leaveRequests'), where('eid', '==', employeeData.eid));
//         const querySnapshot = await getDocs(q);
//         const requests = querySnapshot.docs.map(doc => ({ id: doc.id, ...doc.data() }));
//         setLeaveRequests(requests);
//       } catch (error) {
//         Alert.alert('Error', `Failed to fetch leave status: ${error.message}`);
//       } finally {
//         setLoading(false);
//       }
//     };
...
//   if (loading) {
//     return <Text>Loading your leave requests...</Text>;
//   }

//   return (
//     <View style={styles.container}>
//       <Text style={styles.heading}>Your Leave Requests</Text>
