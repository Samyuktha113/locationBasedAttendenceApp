...
// import { auth, db } from '../services/firebaseAuth';  // Import auth and Firestore
...
//         if (!firstName || !lastName || !employeeId || !email || !password || !dob || !position || !salary || !address || !contact) {
...
//                 // Save user details in Firestore with custom employee ID as the document ID
//                 try {
...
//                     // After storing user details, navigate to Dashboard
//                     navigation.navigate('Dashboard');
//                 } catch (firestoreError) {
//                     console.log("Error adding employee to Firestore: ", firestoreError);
...
//             <Text className="text-2xl font-bold">Register Employee</Text>
//             <TextInput
//                 onChangeText={setFirstName}
//                 placeholder="First Name"
//                 className="border border-gray-300 w-64 my-2 p-2"
//             />
//             <TextInput
...
//             <Text onPress={goToLogin} className="my-2 text-blue-500">
...
//             <TextInput onChangeText={setDob} placeholder="Date of Birth" />
//             <TextInput onChangeText={setPosition} placeholder="Position" />
//             <TextInput onChangeText={setSalary} placeholder="Salary" keyboardType="numeric" />
//             <TextInput onChangeText={setAddress} placeholder="Address" />
//             <TextInput onChangeText={setContact} placeholder="Contact" keyboardType="phone-pad" />
//             <Button title="Register" onPress={handleRegister} />
...
//     const [employeeId, setEmployeeId] = useState('');
//     const [email, setEmail] = useState('');
//     const [password, setPassword] = useState('12345678');  // Default password set to '12345678'
...
//                         address: address,
//                         contact: contact,
//                         password: password,  // Save the default or entered password
//                         createdAt: new Date(),*/
//                         await setDoc(doc(db, "employees", employeeId), {
//                             firstName: firstName,
//                             lastName: lastName,
...
//                             createdAt: new Date(),
//                             requiresPasswordChange: true,  // Flag to indicate the user needs to change their password
//                         });
...
//     return (
//         <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: "center", alignItems: "center" }}>
//             <Text className="text-3xl font-bold text-blue-600 mb-4">Register Employee</Text>
...
//             />
//             <TextInput
//                 value={password}  // Display the default password in the input field
//                 onChangeText={setPassword}
//                 placeholder="Password"
//                 secureTextEntry
//                 className="border border-gray-300 w-64 p-3 mb-4 rounded-md"
...
//             <Button title="Register" onPress={handleRegister} color="#1D4ED8" />
...
//             // Determine the collection based on the position
//             const collectionName = 
//                 position.toLowerCase() === 'manager' ? 'managers' :
//                 position.toLowerCase() === 'admin' ? 'admins' : 
//                 'employees';

//             // Add employee details to the appropriate Firestore collection
