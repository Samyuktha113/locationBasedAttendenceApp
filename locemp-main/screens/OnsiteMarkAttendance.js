...
//       try {
//         // Reference to the employee's document using their employee ID
//         const employeeRef = doc(db, 'employees', employeeData.eid);

//         // Get the employee document to check if it exists
//         const employeeDoc = await getDoc(employeeRef);

//         if (employeeDoc.exists()) {
//           // If employee exists, update the attendance array
...
//         const attendanceRef = doc(db, 'onsiteAttendance', employeeData.eid);
...
//       <Text style={styles.title}>Mark Attendance</Text>
//       {!isAllowed && (
//               <Text style={styles.message}>Attendance marking is disabled as your leave is approved for today.</Text>
//             )}
//       {userLocation ? (
//         <>
...
//           <Text style={styles.addressText}>Address : {fetchedAddress || 'Fetching address...'}</Text>
//         </>
//       ) : (
...
//         const address = await fetchAddress(userLocation.latitude, userLocation.longitude);
