...
// import { Button, TextInput, Text, StyleSheet, TouchableOpacity,View, Alert } from "react-native";
...
// import { useEmployee } from "../context/EmployeeContext"; // Employee Context for manager details
...
//   const [eid, setEid] = useState(""); // Employee ID to whom the remark is being added
//   const [remark, setRemark] = useState(""); // Remark content


// const addRemark = async () => {
//   if (!eid || !remark) {
//     Alert.alert("Error", "Please provide both Employee ID and Remark.");
//     return;
//   }
...
//         multiline
//       />
//       <Button title="Submit Remark" onPress={addRemark} />
//     </View>
//   );
// };
