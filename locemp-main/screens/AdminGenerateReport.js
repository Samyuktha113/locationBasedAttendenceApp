...
//     const [startDate, setStartDate] = useState(null); // or an initial value
...
//     const fetchAllDocuments = async (collectionName, setData) => {
...
//                                     <Text>Status: {item.status === 'approved' ? 'Approved ✔️' : item.status}</Text>
//                                 </View>
//                             )}
//                             keyExtractor={(item, index) => index.toString()}
//                         />
